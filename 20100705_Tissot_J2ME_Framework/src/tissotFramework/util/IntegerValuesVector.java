...
/** @author André Tissot */
public class IntegerValuesVector extends Vector {
    ...
    public void add(float value) {
        super.addElement(new Integer((int) value));
    }
    ...
    public void add(short value) {
        super.addElement(new Integer(value));
    }
    ...
    public void insertAt(float value, int index) {
        super.insertElementAt(new Integer((int) value), index);
    }
    ...
    public void insertAt(short value, int index) {
        super.insertElementAt(new Integer(value), index);
    }
    ...
    public void setAt(float value, int index) {
        super.setElementAt(new Integer((int) value), index);
    }
    ...
    public void setAt(short value, int index) {
        super.setElementAt(new Integer(value), index);
    }
